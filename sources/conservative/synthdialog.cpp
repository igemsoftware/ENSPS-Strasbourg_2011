...
void synthDialog::on_button_add_reaction_clicked()
{
    ...
    parameters<< this->ui->doubleSpinBox1->value()<<this->ui->doubleSpinBox2->value()<<this->ui->doubleSpinBox3->value()<<this->ui->doubleSpinBox4->value();
    parameters<< this->ui->doubleSpinBox5->value()<<this->ui->doubleSpinBox6->value()<<this->ui->doubleSpinBox7->value()<<this->ui->doubleSpinBox8->value();
    //qDebug(QString::number(parameters.at(1)).toStdString().c_str());
    ...
    if(activators.contains(result) || repressors.contains(result)){
        ...
        emit addSynthRequestFromDia(name,activators,result,repressors,parameters);
        this->close();
    }
}
