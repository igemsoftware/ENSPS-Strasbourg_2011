...
private:
    ...
    float initial_state;		/*!< State of a species */
...
public:
    ...
    */
    Species(string name_s, float state = 0.00);
	...
	\param state : species state
    */
    Species(const char* name_s, float state = 0.00);
    ...
    */
    const float Get_initial_state() const;
