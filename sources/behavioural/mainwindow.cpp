...
void MainWindow::on_commandLinkButton_clicked()
{
    ...
    connect(this->dia,SIGNAL(createSystemRequestFromDia(QString,QStringList,QStringList,QList<double>)),this,SLOT(requestFromSystemDia(QString,QStringList,QStringList,QList<double>)));
    this->dia->exec();
}

void MainWindow::requestFromSystemDia(QString name, QStringList reactions, QStringList var_species, QList<double> timing){
    emit createSystemRequestFromUi(name,reactions,var_species,timing);
}
