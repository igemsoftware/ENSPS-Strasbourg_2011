...
private slots:
    ...
    void requestFromSystemDia(QString name, QStringList reactions, QStringList var_species,QList<double> timing);
...
signals:
    ...
    void createSystemRequestFromUi(QString name, QStringList reactions, QStringList var_species, QList<double> timing);
};
