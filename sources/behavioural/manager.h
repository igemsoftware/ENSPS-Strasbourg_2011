...
public:
    ...
    bool patCreation(QString name, p_Reaction *reaction_in_system_tab, int reaction_in_system_tab_size, QList<double> timing);
...
public slots:
    ...
    void systemCreationRequest(QString name, QStringList reactions, QStringList, QList<double>);
